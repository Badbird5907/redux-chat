...
const GrokLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 1024 1024" fill="none">
    <path d={GROK_PATH_PRIMARY} fill="currentColor" />
    <path d={GROK_PATH_SECONDARY} fill="currentColor" />
  </svg>
);

/** White mark for dark UI (no background). */
const GrokLogoWhite = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 1024 1024" fill="none">
    <path d={GROK_PATH_PRIMARY} fill="#fff" />
    <path d={GROK_PATH_SECONDARY} fill="#fff" />
  </svg>
);

export { GrokLogo, GrokLogoWhite };
