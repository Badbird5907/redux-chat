...
const GeminiLogoWhite = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 296 298" fill="none">
    <title>Gemini</title>
    <mask
      id="gemini-w-a"
    ...
    <g mask="url(#gemini-w-a)">
      <g filter="url(#gemini-w-b)">
        <ellipse cx="163" cy="149" fill="#fff" rx="196" ry="159" />
      </g>
      <g filter="url(#gemini-w-c)">
        <ellipse cx="33.5" cy="142.5" fill="#fff" rx="68.5" ry="72.5" />
      </g>
      <g filter="url(#gemini-w-d)">
        <ellipse cx="19.5" cy="148.5" fill="#fff" rx="68.5" ry="72.5" />
      </g>
      <g filter="url(#gemini-w-e)">
        <path
          fill="#fff"
          d="M194 10.5C172 82.5 65.5 134.333 22.5 135L144-66l50 76.5Z"
        />
      </g>
      <g filter="url(#gemini-w-f)">
        <path
          fill="#fff"
          d="M190.5-12.5C168.5 59.5 62 111.333 19 112L140.5-89l50 76.5Z"
        />
      </g>
      <g filter="url(#gemini-w-g)">
        <path
          fill="#fff"
          d="M194.5 279.5C172.5 207.5 66 155.667 23 155l121.5 201 50-76.5Z"
        />
      </g>
      <g filter="url(#gemini-w-h)">
        <path
          fill="#fff"
          d="M196.5 320.5C174.5 248.5 68 196.667 25 196l121.5 201 50-76.5Z"
        />
    ...
    <defs>
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_b"
          stdDeviation="18"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_c"
          stdDeviation="32"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_d"
          stdDeviation="32"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_e"
          stdDeviation="32"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_f"
          stdDeviation="32"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_g"
          stdDeviation="32"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur
          result="effect1_foregroundBlur_gemini_w_h"
          stdDeviation="32"
        />
      </filter>
    </defs>
...
export { GeminiLogo, GeminiLogoWhite };
